...
public class StandardTrackingWheelLocalizer extends ThreeTrackingWheelLocalizer {
    ...
    // Spacing
    public static double LATERAL_DISTANCE = 9.605295; // in; distance between the left and right wheels
    public static double FORWARD_OFFSET = -6.31; // in; offset of the lateral wheel

    // Multipliers
    public static double X_MULTIPLIER = 0.5; // Multiplier in the X direction
